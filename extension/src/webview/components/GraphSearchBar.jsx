...
export default function GraphSearchBar({ cyRef }) {
    ...
    return (
        <div className="graph-search-bar">
            <svg className="graph-search-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
